     ...
     <section className="sub-section-alternative" id="Projects">
            ...
            <div className="project-container">
                <div className="project-card">
                    <img className="project-image" src="images/project1.png" alt="Project One Image"/>
                ...
                <div className="project-card">
                    <img className="project-image" src="images/project2.png" alt="Project One Image"/>
                ...
                <div className="project-card">
                    <img className="project-image" src="images/project3.png" alt="Project One Image"/>
                ...
                <div className="project-card">
                    <img className="project-image" src="images/project4.png" alt="Project One Image"/>
